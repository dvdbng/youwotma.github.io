...
function get_now_x(){
    return get_x(2011,2,17);
}
function item($name,$pc){
    $pc /= 2;
    echo "<div class='item'><div class='itemname'>$name</div>";
...
?>
<div id="timeline">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width='1322px' height='340px'>
<?php
    global $tmy;
    for($i = 1991; $i<=2012; $i++){
